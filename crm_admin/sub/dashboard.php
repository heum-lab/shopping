...
<div class="row g-2 mb-3">
    <?php
    $kpi_cards = [
        ['label' => '총 작업',     'value' => $kpi['total'],      'color' => '#00E5FF'],
        ['label' => '작업중',      'value' => $kpi['active'],     'color' => '#5dd6a0'],
        ['label' => '오늘 신규',   'value' => $kpi['today_new'],  'color' => '#ffc66e'],
        ['label' => '환불요청',    'value' => $kpi['refund_req'], 'color' => '#ff6b76'],
    ];
